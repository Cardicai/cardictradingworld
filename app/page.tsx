...
export default function Page() {
  return (
    <main className="relative min-h-screen w-full overflow-hidden bg-black text-white">
      ...
      >
        <h1
          className="pointer-events-auto mt-[clamp(0.75rem,6vw,2rem)] select-none text-[clamp(1.1rem,4vw,1.4rem)] font-extrabold tracking-[0.42em] sm:mt-0 sm:text-2xl sm:tracking-[0.6em]"
        >
          CARDIC NEXUS
