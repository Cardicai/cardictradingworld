    ...
    <div className="relative h-full w-full">
      {!isBlocked && (
        <iframe
          ...
          onLoad={handleLoad}
          onError={handleError}
          className="h-full w-full rounded-3xl border border-cyan-300/30 bg-black/80 shadow-[0_0_35px_rgba(34,211,238,0.25)]"
      ...
      {isLoading && !isBlocked && (
        <div className="pointer-events-none absolute inset-0 z-10 flex items-center justify-center rounded-3xl bg-black/70 backdrop-blur">
      ...
      {isBlocked && (
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center gap-4 rounded-3xl border border-cyan-400/40 bg-black/80 p-8 text-center text-cyan-50">
